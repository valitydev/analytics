...
PRIMARY KEY id
SOURCE(ODBC(connection_string 'DSN=myconnection;UID=user;PWD=password;HOST=host;PORT=5432;DATABASE=analytics' table 'analytics.country'))
LAYOUT(HASHED())
LIFETIME(MIN 300 MAX 360)

--trade_bloc--
CREATE
DICTIONARY trade_bloc_dictionary (
    id 				 UInt64,
    version_id       UInt64,
...
PRIMARY KEY id
SOURCE(ODBC(connection_string 'DSN=myconnection;UID=user;PWD=password;HOST=host;PORT=5432;DATABASE=analytics' table 'analytics.trade_bloc'))
LAYOUT(HASHED())
LIFETIME(MIN 300 MAX 360)

--shop--
CREATE
DICTIONARY shop_dictionary (
	id 				 UInt64,
	event_id         String,
    event_time		 String,
	party_id         String,

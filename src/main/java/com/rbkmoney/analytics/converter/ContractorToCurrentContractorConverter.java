...
public class ContractorToCurrentContractorConverter implements Converter<Contractor, com.rbkmoney.analytics.domain.db.tables.pojos.Contractor> {
    ...
    public com.rbkmoney.analytics.domain.db.tables.pojos.Contractor convert(Contractor contractor) {
        ...
        if (contractor.isSetRegisteredUser()) {
            ...
            currentContractor.setLegalEntityType(TBaseUtil.unionFieldToEnum(contractor.getLegalEntity(), com.rbkmoney.analytics.domain.db.enums.LegalEntity.class));
            if (contractor.getLegalEntity().isSetRussianLegalEntity()) {
                ...
                currentContractor.setRussianLegalEntityRepresentativePosition(russianLegalEntity.getRepresentativePosition());
                currentContractor.setRussianLegalEntityRepresentativeFullName(russianLegalEntity.getRepresentativeFullName());
                currentContractor.setRussianLegalEntityRepresentativeDocument(russianLegalEntity.getRepresentativeDocument());
                currentContractor.setRussianLegalEntityBankAccount(russianLegalEntity.getRussianBankAccount().getAccount());
                currentContractor.setRussianLegalEntityBankName(russianLegalEntity.getRussianBankAccount().getBankName());
                currentContractor.setRussianLegalEntityBankPostAccount(russianLegalEntity.getRussianBankAccount().getBankPostAccount());
                ...
                currentContractor.setInternationalLegalEntityRegisteredAddress(internationalLegalEntity.getRegisteredAddress());
                currentContractor.setInternationalActualAddress(internationalLegalEntity.getActualAddress());
                currentContractor.setInternationalLegalEntityRegisteredNumber(internationalLegalEntity.getRegisteredNumber());
            }
        } else if (contractor.isSetPrivateEntity()) {
            currentContractor.setPrivateEntityType(TBaseUtil.unionFieldToEnum(contractor.getPrivateEntity(), com.rbkmoney.analytics.domain.db.enums.PrivateEntity.class));
            if (contractor.getPrivateEntity().isSetRussianPrivateEntity()) {
                ...
                if (russianPrivateEntity.getContactInfo() != null) {
                    ...
                    currentContractor.setRussianPrivateEntityPhoneNumber(russianPrivateEntity.getContactInfo().getPhoneNumber());
                }
